...
CREATE TABLE `Categorias` (
  ...
  KEY `Categorias_CategoriaNome` (`CategoriaNome`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Categorias`
--
INSERT INTO `Categorias` (`CategoriaID`,`CategoriaNome`,`Descricao`,`Imagem`) VALUES 
...
CREATE TABLE `Clientes` (
  ...
  `Regioes` varchar(15) DEFAULT NULL,
  `CodigoPostal` varchar(10) DEFAULT NULL,
  `Pais` varchar(15) DEFAULT NULL,
  `Telefone` varchar(24) DEFAULT NULL,
  `Fax` varchar(24) DEFAULT NULL,
  PRIMARY KEY (`ClienteID`),
  KEY `Clientes_Cidade` (`Cidade`),
  KEY `Clientes_Empresa` (`Empresa`),
  KEY `Clientes_CodigoPostal` (`CodigoPostal`),
  KEY `Clientes_Regioes` (`Regioes`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Clientes`
--
INSERT INTO `Clientes` (`ClienteID`,`Empresa`,`Contato`,`Titulo`,`Endereco`,`Cidade`,`Regioes`,`CodigoPostal`,`Pais`,`Telefone`,`Fax`) VALUES 
...
--
-- Definition of table `EmpregadoLocalizacao`
--

DROP TABLE IF EXISTS `EmpregadoLocalizacao`;
CREATE TABLE `EmpregadoLocalizacao` (
  `EmpregadoID` int(11) NOT NULL,
  `LocalizacaoID` varchar(20) NOT NULL,
  PRIMARY KEY (`EmpregadoID`,`LocalizacaoID`),
  KEY `FK_EmpregadoLocalizacao_Localizacoes` (`LocalizacaoID`),
  CONSTRAINT `FK_EmpregadoLocalizacao_Empregados` FOREIGN KEY (`EmpregadoID`) REFERENCES `Empregados` (`EmpregadoID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_EmpregadoLocalizacao_Localizacoes` FOREIGN KEY (`LocalizacaoID`) REFERENCES `Localizacoes` (`LocalizacaoID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `EmpregadoLocalizacao`
--
INSERT INTO `EmpregadoLocalizacao` (`EmpregadoID`,`LocalizacaoID`) VALUES 
 (5,'10019'),
 (5,'10038'),
 (5,'11747'),
 (5,'14450'),
...
--
-- Definition of table `Empregados`
--

DROP TABLE IF EXISTS `Empregados`;
CREATE TABLE `Empregados` (
  `EmpregadoID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `Empregados_Sobrenome` (`Sobrenome`),
  KEY `Empregados_CodigoPostal` (`CodigoPostal`),
  KEY `FK_Empregados_Empregados` (`Gestor`),
  CONSTRAINT `FK_Empregados_Empregados` FOREIGN KEY (`Gestor`) REFERENCES `Empregados` (`EmpregadoID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Empregados`
--
INSERT INTO `Empregados` (`EmpregadoID`,`Sobrenome`,`Nome`,`Titulo`,`TituloCortesia`,`DataNascimento`,`DataContratacao`,`Endereco`,`Cidade`,`Regioes`,`CodigoPostal`,`Pais`,`Telefone`,`Extensao`,`Foto`,`Notas`,`Gestor`,`urlFoto`) VALUES 
...
--
-- Definition of table `DetalheFatura`
--
...
CREATE TABLE `DetalheFatura` (
  ...
  KEY `DetalheFatura_FaturaId` (`FaturaId`),
  KEY `DetalheFatura_DetalheFatura` (`FaturaId`),
  KEY `DetalheFatura_ProdutoID` (`ProdutoID`),
  KEY `DetalheFatura_ProdutosDetalheFatura` (`ProdutoID`),
  CONSTRAINT `FK_DetalheFatura_Faturas` FOREIGN KEY (`FaturaId`) REFERENCES `Faturas` (`FaturaId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_DetalheFatura_Produtos` FOREIGN KEY (`ProdutoID`) REFERENCES `Produtos` (`ProdutoID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `DetalheFatura`
--
INSERT INTO `DetalheFatura` (`FaturaId`,`ProdutoID`,`PrecoUnitario`,`Quantidade`,`Desconto`) VALUES 
 (10248,11,14,12,0),
 (10248,42,9.8,10,0),
 (10248,72,34.8,5,0),
 (10249,14,18.6,9,0),
...
CREATE TABLE `Faturas` (
  ...
  `EmpregadoID` int(11) DEFAULT NULL,
  ...
  `NomeEnvio` varchar(40) DEFAULT NULL,
  `EnderecoEnvio` varchar(60) DEFAULT NULL,
  `CidadeEnvio` varchar(15) DEFAULT NULL,
  `RegiaoEnvio` varchar(15) DEFAULT NULL,
  `CodigoPostalEnvio` varchar(10) DEFAULT NULL,
  `PaisEnvio` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`FaturaId`),
  KEY `Faturas_ClienteID` (`ClienteID`),
  KEY `Faturas_ClientesFaturas` (`ClienteID`),
  KEY `Faturas_EmpregadoID` (`EmpregadoID`),
  KEY `Faturas_EmpregadosFaturas` (`EmpregadoID`),
  KEY `Faturas_DataFatura` (`DataFatura`),
  KEY `Faturas_DataEnvio` (`DataEnvio`),
  KEY `Faturas_CorreiosFaturas` (`FormaEnvio`),
  KEY `Faturas_CodigoPostalEnvio` (`CodigoPostalEnvio`),
  KEY `FK_Faturas_Clientes` (`ClienteID`),
  CONSTRAINT `FK_Faturas_Clientes` FOREIGN KEY (`ClienteID`) REFERENCES `Clientes` (`ClienteID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_Faturas_Empregados` FOREIGN KEY (`EmpregadoID`) REFERENCES `Empregados` (`EmpregadoID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_Faturas_Correios` FOREIGN KEY (`FormaEnvio`) REFERENCES `Correios` (`CorreioID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=11078 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Faturas`
--
INSERT INTO `Faturas` (`FaturaId`,`ClienteID`,`EmpregadoID`,`DataFatura`,`DataRegistro`,`DataEnvio`,`FormaEnvio`,`Transporte`,`NomeEnvio`,`EnderecoEnvio`,`CidadeEnvio`,`RegiaoEnvio`,`CodigoPostalEnvio`,`PaisEnvio`) VALUES 
...
CREATE TABLE `Produtos` (
  ...
  `ProvedorID` int(11) DEFAULT NULL,
  `CategoriaID` int(11) DEFAULT NULL,
  `QuantidadePorUnidade` varchar(20) DEFAULT NULL,
  `PrecoUnitario` double DEFAULT '0',
  `UnidadesEstoque` smallint(6) DEFAULT '0',
  `UnidadesPedidas` smallint(6) DEFAULT '0',
  `NivelReabastecimento` smallint(6) DEFAULT '0',
  `Descontinuado` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ProdutoID`),
  KEY `Produtos_CategoriasProdutos` (`CategoriaID`),
  KEY `Produtos_CategoriaID` (`CategoriaID`),
  KEY `Produtos_ProdutoNome` (`ProdutoNome`),
  KEY `Produtos_ProvedorID` (`ProvedorID`),
  KEY `Produtos_ProvedoresProdutos` (`ProvedorID`),
  CONSTRAINT `FK_Produtos_Categorias` FOREIGN KEY (`CategoriaID`) REFERENCES `Categorias` (`CategoriaID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_Produtos_Provedores` FOREIGN KEY (`ProvedorID`) REFERENCES `Provedores` (`ProvedorID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Produtos`
--
INSERT INTO `Produtos` (`ProdutoID`,`ProdutoNome`,`ProvedorID`,`CategoriaID`,`QuantidadePorUnidade`,`PrecoUnitario`,`UnidadesEstoque`,`UnidadesPedidas`,`NivelReabastecimento`,`Descontinuado`) VALUES 
...
--
INSERT INTO `Regioes` (`RegioesID`,`RegioesDescricao`) VALUES 
 (1,'Eastern'),
 (2,'Western'),
 (3,'Northern'),
 (4,'Southern');
...
--
-- Definition of table `Correios`
--

DROP TABLE IF EXISTS `Correios`;
CREATE TABLE `Correios` (
  `CorreioID` int(11) NOT NULL AUTO_INCREMENT,
  `Empresa` varchar(40) NOT NULL,
  `Telefone` varchar(24) DEFAULT NULL,
...
--
INSERT INTO `Correios` (`CorreioID`,`Empresa`,`Telefone`) VALUES 
...
CREATE TABLE `Provedores` (
  `ProvedorID` int(11) NOT NULL AUTO_INCREMENT,
  `Empresa` varchar(40) NOT NULL,
  `Contato` varchar(30) DEFAULT NULL,
  `Titulo` varchar(30) DEFAULT NULL,
  `Endereco` varchar(60) DEFAULT NULL,
  ...
  KEY `Provedores_Empresa` (`Empresa`),
  KEY `Provedores_PostalCode` (`CodigoPostal`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Provedores`
--
INSERT INTO `Provedores` (`ProvedorID`,`Empresa`,`Contato`,`Titulo`,`Endereco`,`Cidade`,`Regioes`,`CodigoPostal`,`Pais`,`Telefone`,`Fax`,`Pagina`) VALUES 
 ...
 (16,'Bigfoot Breweries','Cheryl Saylor','Regioesal Account Rep.','3400 - 8th Avenue Suite 210','Bend','OR','97101','USA','(503) 555-9931','',''),
...
--
-- Definition of table `Localizacoes`
--
...
CREATE TABLE `Localizacoes` (
  ...
  KEY `FK_Localizacoes_Regioes` (`RegioesID`),
  CONSTRAINT `FK_Localizacoes_Regioes` FOREIGN KEY (`RegioesID`) REFERENCES `Regioes` (`RegioesID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Localizacoes`
--
INSERT INTO `Localizacoes` (`LocalizacaoID`,`LocalizacaoDescricao`,`RegioesID`) VALUES 
 ('10019','New York',1),
 ('10038','New York',1),
 ('11747','Mellvile',1),
 ('14450','Fairport',1),
...
select * from Faturas where EmpregadoId  = '2' or  EmpregadoId  = '3' or  EmpregadoId  = '5' or  EmpregadoId  = '8' or  EmpregadoId  = '9' order by EmpregadoId ASC
...
Select * from detalhefatura Where FaturaId, Produto_ID, Quantidade
